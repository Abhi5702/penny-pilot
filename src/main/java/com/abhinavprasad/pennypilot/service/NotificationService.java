...
import com.abhinavprasad.pennypilot.repository.ProfileRepository;
    ...
    public void sendDailyExpenseSummary() {
        ...
        for (ProfileEntity profile : profiles) {
            ...
            if (!todaysExpenses.isEmpty()) {
                ...
                table.append("</table>");
                String body = "Hi "+profile.getFullName()+",<br/><br/> Here is a summary of your expenses for today:<br/><br/>"+table+"<br/><br/>Best regards,<br/>Penny Pilot Team";
